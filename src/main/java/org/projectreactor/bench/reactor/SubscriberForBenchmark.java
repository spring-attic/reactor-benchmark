...
class SubscriberForBenchmark implements Subscriber<Buffer> {
	...
	private CountDownLatch nextSignalReceived = new CountDownLatch(1);
    ...
    public void awaitNextSignal(long timeoutMillis) throws InterruptedException {
        nextSignalReceived.await(timeoutMillis, TimeUnit.MILLISECONDS);
    }
